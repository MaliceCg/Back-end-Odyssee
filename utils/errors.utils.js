...
/////////////////////////erreur upload////////////////////
module.exports.uploadErrors = (err) => { let errors = {format:'', maxSize: ''};
if (err.message.includes('pas bon format'))
errors.format = "change ton format bg";

if (err.message.includes('trop grand'))
errors.maxSize = "reduis ton image";
